 ...
 */
export function CommuneDetail({ commune, waterSourceDate, now }: Props) {
  ...
  return (
    <>
      ...
      <div className="panel-detail scroll-thin">
        {/* Ce que l'on veut savoir en premier d'une commune : le temps qu'il y
            fait maintenant, puis d'un coup d'œil son air et son eau. */}
