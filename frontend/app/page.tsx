...
export default function Home() {
  ...
  // Initialiser l'état avec les données du cache (fonction lazy pour éviter les problèmes SSR)
    ...
    <main className="flex min-h-screen flex-col items-center justify-start pt-8 pb-12 px-4 sm:px-6 lg:px-8 relative bg-gray-50">
      <div className="w-full max-w-7xl">
        ...
        <div className="flex flex-col lg:flex-row gap-6 w-full items-start">
          {/* Carte */}
          <div className="flex-1 w-full shadow-lg rounded-lg overflow-hidden flex items-center justify-center" style={{ height: '700px' }}>
            <GuadeloupeMap
              data={airData}
